                ...
                <div class="col-md-8 text-center">
                    <form action="'.url('account/edit.php').'" method="post">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="full-name" value="'.$user['full_name'].'">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="new-pass" name="new-pass" placeholder="New-password">
                        </div>
                        <div class="form-group">
                            <label for="conf-pass" class="hiden-label">Confirm-password:</label>
                            <input type="password" class="form-control" id="conf-pass" name="confirm-pass" placeholder="Confirm-password">
                        </div>
                        <div class="form-group col-12 text-center">
                            <span>Profile picture</span>
                            <span class="account-section-info-img"></span>
                            <input type="submit" name="edit" value="save" style="display:none;"/>
                        ...
                        <div class="form-group">
                            <button type="submit" tabindex="0" class="btn btn-primary my-main-button" name="edit" value="save">Save changes</button>
